Minh Explaing About CS

This gist is to walkthrough to understand of Regular Expression (Regex). This tool can be use to match a certain charater combination within a string. This is extremely useful for getting information from any given page. 

## Summary

The code below is use as an example to learn how Regex is apply
...
### FlagsA regex flag is not used in the matching email code that is being used for this tutorial. A regular expression typically comes in the form:
...
This tutorial was created and presented by Minh Nguyen
